...
def emg_rectification(x, Fs, idx, channel_num):
    ...
    mvc = [0.1747, 0.1369, 0.1204, 0.1607, 0.1478, 0.1202, 0.0728, 0.1037, 0.2073, 0.1785, 0.0406, 0.0511, 0.0838,
           0.1731, 0.1259, 0.1388, 0.0839, 0.1107, 0.1218, 0.0754]
    # ref = 0
    ref = mvc[idx]
...
if __name__ == "__main__":
    ...
    emg_label = ['test 2024_05_17 17_52_00',
                 'test 2024_05_17 17_55_18',  # 俯卧，背阔肌
                 'test 2024_05_17 18_05_06',  # 侧卧，冈上肌
                 'test 2024_05_17 18_22_46',  # 侧卧，冈下肌
                 'test 2024_05_17 18_27_10',
                 'test 2024_05_17 18_30_20',  # 胸大肌，坐姿夹胸
                 'test 2024_05_17 18_36_31',  # 三角肌前束，三角肌中束
                 'test 2024_05_17 18_41_21',  # 三角肌前束，三角肌中束
                 'test 2024_05_17 18_43_51',  # 背阔肌，坐姿划船
                 'test 2024_05_17 18_45_39',
                 'test 2024_05_17 18_49_16',  # 三角肌后束，肩部外展

                 'test 2024_05_17 16_27_52',
                 'test 2024_05_17 16_30_59',
                 'test 2024_05_17 16_33_17',
                 'test 2024_05_17 16_37_38',
                 'test 2024_05_17 16_41_21'
                 ]
