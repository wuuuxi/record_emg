...
if __name__ == "__main__":
    ...
    folder_path = ('C:/Users/hkclr_user/OneDrive - The Chinese University of Hong Kong/Experiment/'
                   '20240517_HKSI_deadlift/Resorted/deadlift/MVN-007 45kg/')
    ...
    timestep_emg_2 = [[8.783, 9.5, 9.5, 10.65],
                      ...
                      [16.75, 17.55, 17.55, 18.633],
                      [19.416, 20.366, 20.366, 21.149],
                      [21.883, 22.533, 22.533, 23.566]]

    timestep_emg_3 = [[8.533, 9.35, 9.35, 10.6],
                      [12.05, 12.95, 12.95, 14.233],
                      [15.599, 16.466, 16.466, 17.683],
                      [18.983, 19.916, 19.916, 21.066],
                      [22.099, 22.999, 22.999, 24.299],
                      [25.299, 26.349, 26.349, 27.565]]
